                    ...
                    <div class="modal-header bg-gray">
                        <h5 class="modal-title"> SRL Uganda |
                            ...
                            <span class="text-danger">
                                ...
                                Mark Modular Test Answer Submitted by the Student
                    ...
                    <div class="modal-body ">
                        ...
                        <form action="<?php echo e(route('MassUpdate')); ?>" class="row" method="POST">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="TableName" value="attempt_modular_tests">
...
<?php endif; ?>
<?php /**PATH /var/www/html/srl.local/sys/MarkModular/ScoreModular.blade.php ENDPATH**/ ?>