...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    <?php echo Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Hello ' . Auth::user()->name . '. Select practical test to attempt', $Msg = null); ?>
...
<!--end::Card body-->
<?php /**PATH /var/www/html/srl.local/sys/AttemptExams/SelectPracticalToAttempt.blade.php ENDPATH**/ ?>