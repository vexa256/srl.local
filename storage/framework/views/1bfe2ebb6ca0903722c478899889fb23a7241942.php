<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-body pt-3 bg-light shadow-lg table-responsive">
            <?php echo Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Course Modular Test Activation Management', $Msg = null); ?>
    ...
    $data = [
        ...
        'route' => route('DeActivateSelectedTest', ['id' => $data->id, 'TableName' => 'modular_tests']),
    ...
    $data = [
        ...
        'route' => route('ActivateSelectedTest', ['id' => $data->id, 'TableName' => 'modular_tests']),
...
<?php /**PATH /var/www/html/srl.local/sys/EnableExams/EnableModular.blade.php ENDPATH**/ ?>