...
<div class="card-body shadow-lg pt-3 bg-light table-responsive">
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo e(route('AcceptMarkPractical')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <?php if(isset($Courses)): ?>
                            ...
                            <?php $__currentLoopData = $Courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($data->id); ?>">
                                    <?php echo e($data->CourseName); ?> (<?php echo e($data->Module); ?>)</option>
...
<?php /**PATH /var/www/html/srl.local/sys/MarkPractical/SelectPractical.blade.php ENDPATH**/ ?>