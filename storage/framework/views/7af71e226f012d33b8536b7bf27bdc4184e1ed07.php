...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    <?php echo Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Manage all UnMarked Post Test Assessments', $Msg = null); ?>
...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    ...
    <table class="  table table-rounded table-bordered  border gy-3 gs-3">
        ...
        <tbody>
            <?php if(isset($PostTests)): ?>
                <?php $__currentLoopData = $PostTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($data->PostTestTitle); ?></td>
                        ...
                        <td>
                            <a data-bs-toggle="modal" class="btn btn-sm btn-dark shadow-lg "
...
<?php if(isset($PostTests)): ?>
    <?php $__currentLoopData = $PostTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('Mark.PostAns', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('Mark.ScorePost', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('Mark.Guide', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('Mark.Results', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /var/www/html/srl.local/sys/Mark/MarkPost.blade.php ENDPATH**/ ?>