    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('SubmitPostAnswer')); ?>" class="row" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <input type="hidden" name="PostTestUuid" value="<?php echo e($data->uuid); ?>">
...
<?php /**PATH /var/www/html/srl.local/sys/AttemptExams/PostAnswer.blade.php ENDPATH**/ ?>