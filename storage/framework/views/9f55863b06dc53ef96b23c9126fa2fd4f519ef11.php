...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    <?php echo Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Manage all UnMarked Practical Tests For ' . $Module, $Msg = null); ?>
                    ...
                    <div class="modal-header bg-gray">
                        <h5 class="modal-title"> SRL Uganda |
                            ...
                            <span class="text-danger">
                                ...
                                View Practical Test Question Attempted by the Student
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <textarea class="editorme">
                                        ...
                                        <?php echo $mark->PracticalQuestion; ?>
...
<?php if(isset($ModularTests)): ?>
    <?php $__currentLoopData = $ModularTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="modal-header bg-gray">
                        <h5 class="modal-title"> SRL Uganda |
                            ...
                            <span class="text-danger">
                                ...
                                <?php echo e($post->Name); ?> . | The Course is <?php echo e($CourseName); ?> (<?php echo e($Module); ?>)
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <textarea class="editorme">
                                        ...
                                        <?php echo $post->PracticalQuestion; ?>
...
<?php echo $__env->make('MarkPractical.PracticalAns', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('MarkPractical.ScorePractical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('MarkPractical.Guide', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('MarkPractical.Results', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /var/www/html/srl.local/sys/MarkPractical/MarkPractical.blade.php ENDPATH**/ ?>