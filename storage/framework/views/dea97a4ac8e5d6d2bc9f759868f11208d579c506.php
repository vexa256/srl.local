...
<div class="card-body shadow-lg pt-3 bg-light table-responsive">
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo e(route('AcceptEnablePostTestSelectCourse')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/srl.local/sys/EnableExams/SelectPostTest.blade.php ENDPATH**/ ?>