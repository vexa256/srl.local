            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('MassInsert')); ?>" class="row"
                    ...
                    <input type="hidden" name="uuid"
                        value="<?php echo e(md5(date('Y-m-d H:I:S') . uniqid() . md5(\Hash::make(uniqid() . 'AFC' . date('Y-m-d H:I:S'))))); ?>">
...
<?php /**PATH /var/www/html/srl.local/sys/ModularTests/NewModularTest.blade.php ENDPATH**/ ?>