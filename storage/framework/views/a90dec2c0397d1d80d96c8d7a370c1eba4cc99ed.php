    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title"> Let's create a new schedule for the
                    selected course
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('NewDoc')); ?>" class="row" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <input type="hidden" name="TableName" value="course_schedules">
                    ...
                    <input type="hidden" name="uuid" value="<?php echo e(md5(date('Y-m-d H:I:S') . uniqid())); ?>">
...
<?php /**PATH /var/www/html/srl.local/sys/courses/NewSchedule.blade.php ENDPATH**/ ?>