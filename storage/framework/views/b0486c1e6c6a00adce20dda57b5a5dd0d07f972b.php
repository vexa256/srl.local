<?php if(isset($ModularTests)): ?>
    <?php $__currentLoopData = $ModularTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="modal-header bg-gray">
                        <h5 class="modal-title"> SRL Uganda |
                            ...
                            <span class="text-danger">
                                ...
                                Mark Practical Test Answer Submitted by the Student
                    ...
                    <div class="modal-body ">
                        ...
                        <form action="<?php echo e(route('MassUpdate')); ?>" class="row" method="POST">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="TableName" value="attempt_practical_tests">
...
<?php endif; ?>
<?php /**PATH /var/www/html/srl.local/sys/MarkPractical/ScorePractical.blade.php ENDPATH**/ ?>