    ...
    <div class="col-md-3">
        ...
        <a href="#" class="card shadow-lg bg-dark hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-inverse-info fw-bolder fs-5 mb-1 mt-3"> <?php echo e($Notes); ?>
...
<?php /**PATH /var/www/html/srl.local/sys/StudentStats/Stats.blade.php ENDPATH**/ ?>