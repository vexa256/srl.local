    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative"
                style="background-image: url(<?php echo e(asset('assets/login.jpg')); ?>);
               ">
                <!--begin::Wrapper-->
                <div
                    ...
                    <div style=" background-color:rgba(0,0,0,0.5)"
                        ...
                        <!--begin::Logo-->
                        <a href="<?php echo e(url('/login')); ?>" class="py-9">
                            <img alt="Logo" style="background-color: white"
                                src="<?php echo e(asset('logo_retina.png')); ?>"
                                class="h-120px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
...
<?php /**PATH /var/www/html/srl.local/resources/views/auth/login.blade.php ENDPATH**/ ?>