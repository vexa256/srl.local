<div class="modal fade" id="NewVid">
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title"> Upload a new notes video to
                    ...
                    <div class="row">
                        ...
                        <div class="mt-3  mb-3 col-md-4  ">
                            <label id="label" for="" class=" required form-label">Upload
                                ...
                                Video Notes (Only MP4 is Supported)</label>
            ...
            <div class="modal-footer">
                <a href="#MgtVid" type="button" class="btn btn-info"
                    data-bs-dismiss="modal" data-bs-toggle="modal">Close</a>
...
<?php /**PATH /var/www/html/srl.local/sys/notes/NewVideo.blade.php ENDPATH**/ ?>