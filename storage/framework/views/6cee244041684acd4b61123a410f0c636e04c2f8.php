    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('SubmitModularAnswer')); ?>" class="row" method="POST">
                    <?php echo csrf_field(); ?>


                    <div class="mt-5  mb-5 col-md-12 ">
                        <label id="label" for="" class=" required form-label">Modular Test Assessment
                            Question(s) </label>
                    ...
                    <input type="hidden" name="ModularTestUuid" value="<?php echo e($data->uuid); ?>">
                    ...
                    <textarea name="ModularQuestion" class="d-none">
...
<?php /**PATH /var/www/html/srl.local/sys/AttemptExams/ModularAnswer.blade.php ENDPATH**/ ?>