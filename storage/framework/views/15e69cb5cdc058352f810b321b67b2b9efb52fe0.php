    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title"> Create a new Administrator Account <span class="text-danger">
                        | The entered email will be used as the default username. Please use a strong
                        password
                    </span>
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('MassInsert')); ?>" class="row" method="POST"> <?php echo csrf_field(); ?>
                    <div class="row">
                    ...
                    <input type="hidden" name="UserID" value="<?php echo e(md5(uniqid() . 'AFC' . date('Y-m-d H:I:S'))); ?>">
...
<?php /**PATH /var/www/html/srl.local/sys/users/NewAdmin.blade.php ENDPATH**/ ?>