...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    <?php echo Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Let\'s manage applicable course post tests.', $Msg = null); ?>

</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    <?php echo e(HeaderBtn($Toggle = 'New', $Class = 'btn-danger', $Label = 'New Post-Test', $Icon = 'fa-plus')); ?>
...
<!--end::Card body-->
<?php echo $__env->make('PostTests.NewPostTest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php if(isset($PostTests)): ?>
    <?php $__currentLoopData = $PostTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <form novalidate action="<?php echo e(route('MassUpdate')); ?>" class=""
            ...
            <div class="row">
                ...
                <?php echo e(RunUpdateModalFinal($ModalID = $data->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $data->id, $col = '12', $te = '12', $TableName = 'post_tests')); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/srl.local/sys/PostTests/MgtPostTest.blade.php ENDPATH**/ ?>