<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-body pt-3 bg-light shadow-lg table-responsive">
            <?php echo Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Course Post Test Activation Management', $Msg = null); ?>
    ...
    $data = [
        ...
        'route' => route('DeActivateSelectedTest', ['id' => $data->id, 'TableName' => 'post_tests']),
    ...
    $data = [
        ...
        'route' => route('ActivateSelectedTest', ['id' => $data->id, 'TableName' => 'post_tests']),
...
<?php /**PATH /var/www/html/srl.local/sys/EnableExams/PostTests.blade.php ENDPATH**/ ?>