<?php echo $__env->make('public.letterHeader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body style="tab-interval:36pt;">
    ...
    <div class="Section0" style="layout-grid:18.0000pt;">
        <p class=MsoNormal align=center style="text-align:center;"><img width="198" height="56"
                src="<?php echo e(asset('assets/CT001 F26 Admission letter_1.00.png')); ?>" align="left" hspace="12"><img
                width="139" height="66" src="<?php echo e(asset('assets/CT001 F26 Admission letter_1.01.png')); ?>"
    ...
    font-size:11.0000pt;">Re:
                        Course Admission letter to <?php echo e($data['Course']); ?></span></u></b><b><u><span
                        style="mso-spacerun:'yes';font-family:Calibri;mso-bidi-font-family:'Times New Roman';
    font-weight:bold;text-decoration:underline;text-underline:single;
    font-size:11.0000pt;">
                        <o:p></o:p>
    ...
    font-size:11.0000pt;">This
                ...
                <?php echo e(date('F j, Y', strtotime($data['From']))); ?> to
                <?php echo e(date('F j, Y', strtotime($data['To']))); ?>.</span><span
                style="mso-spacerun:'yes';font-family:Calibri;mso-bidi-font-family:'Times New Roman';
    font-size:11.0000pt;">
                <o:p></o:p>
            </span></p>
    ...
    font-size:11.0000pt;">
        ...
        <p class=MsoNormal><span
                style="mso-spacerun:'yes';font-family:Calibri;mso-bidi-font-family:'Times New Roman';
    font-size:11.0000pt;"><?php echo e($data['Cord']); ?></span><span
                style="mso-spacerun:'yes';font-family:Calibri;mso-bidi-font-family:'Times New Roman';
    font-size:11.0000pt;">
                <o:p></o:p>
            </span></p>
    ...
    font-size:11.0000pt;">
                <p class=MsoNormal align=center style="text-align:center;"><img width="198" height="56"
                        align="left" hspace="12" src="<?php echo e(asset($data['Signature'])); ?>" hspace="12">
                </p>
...
<?php /**PATH /var/www/html/srl.local/sys/public/AdmissionLetter.blade.php ENDPATH**/ ?>